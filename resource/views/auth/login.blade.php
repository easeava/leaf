  ...
  <head>
    ...
    window.onload = function()
    {
      ...
      if (navigator.appVersion.indexOf("Windows NT 6.2") != -1)
        document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="{{ admin_asset('vendor/leaf/pages/css/windows.chrome.fix.css') }}" />'
    }
    </script>
  </head>
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="{{ admin_asset('vendor/leaf/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg') }}" alt="" class="lazy">
        <!-- END Background Pic-->
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="{{ admin_asset('vendor/leaf/assets/img/demo/pages_icon.png') }}" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/demo/pages_icon_2x.png') }}" height="60" src="{{ admin_asset('vendor/leaf/assets/img/demo/pages_icon.png') }}" width="60">
              </div>
