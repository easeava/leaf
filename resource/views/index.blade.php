                        ...
                        <div class="notification-item unread clearfix">
                          <div class="heading">
                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                              <img width="30" height="30" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/1x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/1.jpg') }}" alt="" src="{{ admin_asset('vendor/leaf/assets/img/profiles/1.jpg') }}">
                            </div>
                            <a href="#" class="text-complete pull-left">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-sm-6 d-flex flex-column">
                ...
                <div class="card social-card share share-other full-width m-b-10 d-flex flex-1 full-height no-border sm-vh-75" data-social="item">
                  ...
                  <div class="card-content flex-1" data-pages-bg-image="{{ admin_asset('vendor/leaf/assets/img/social_new.jpg') }}">
                    <ul class="buttons ">
                      <li>
                  ...
                  <div class="card-header clearfix">
                    <div class="user-pic">
                      <img alt="Avatar" width="33" height="33" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar_small2x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar_small2x.jpg') }}">
                    </div>
                    <h5>David Nester</h5>
                      ...
                      <div class="bg-master-light padding-20 full-width ">
                        <div class="row">
                          ...
                          <div class="col-2 text-center">
                            <a href="#" class="block m-t-15"><img src="{{ admin_asset('vendor/leaf/assets/img/plus.svg') }}"></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/1x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/1.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/1x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/2x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/2.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/2x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/3x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/3.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/3x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/4x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/4.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/4x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/5x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/5.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/5x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/6x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/6.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/6x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/7x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/7.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/7x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/8x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/8.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/8x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/9x.jpg') }}" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/9.jpg') }}" src="{{ admin_asset('vendor/leaf/assets/img/profiles/9x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar_small.jpg') }}" alt="" data-src="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar_small.jpg') }}" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/profiles/avatar_small2x.jpg') }}">
                  </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{ admin_asset('vendor/leaf/assets/img/logo.png') }}" alt="logo" data-src="{{ admin_asset('vendor/leaf/assets/img/logo.png') }}" data-src-retina="{{ admin_asset('vendor/leaf/assets/img/logo_2x.png') }}" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
